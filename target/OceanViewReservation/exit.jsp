...
<head>
    ...
    <style>
        ...
        .exit-container {
            ...
            padding: 50px 40px; border-radius: 20px; width: 100%; max-width: 450px; text-align: center;
            box-shadow: 0 15px 40px rgba(0,0,0,0.2);
            border: 1px solid rgba(255,255,255,0.6);
            border-top: 6px solid var(--danger); /* රතු පැහැති ඉහළ තීරුව */
        }
        ...
        .login-btn {
            ...
            color: white; text-decoration: none; padding: 14px 30px; font-size: 16px; border-radius: 30px;
            font-weight: 600; transition: 0.3s; font-family: 'Poppins', sans-serif;
