...
<head>
    <meta charset="UTF-8">
    <title>Update Profile - Ocean View Resort</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root { --primary: #005f73; --secondary: #0a9396; --text-dark: #1a1a1a; }
        body { font-family: 'Poppins', sans-serif; margin: 0; padding: 0; background: url('https://images.unsplash.com/photo-1618140052121-39fc6db33972?q=80&w=2070&auto=format&fit=crop') no-repeat center center fixed; background-size: cover; min-height: 100vh; display: flex; flex-direction: column; }
            ...
            <div class="form-grid">
                <div class="input-group full-width">
                    ...
                    <div class="input-container"><i class="fa-solid fa-user-tag"></i>
                        <input type="text" name="fullName" value="<%= u.getFullName() != null ? u.getFullName() : "" %>" required></div>
                </div>
                <div class="input-group">
                    <label>Username (System ID)</label>
                    <div class="input-container"><i class="fa-solid fa-id-badge"></i>
                        <input type="text" name="username" value="<%= u.getUsername() %>" readonly style="background: #eef2f5; color: #888;"></div>
                </div>
                <div class="input-group">
                    <label>Password</label>
                    <div class="input-container"><i class="fa-solid fa-lock"></i>
                        <input type="password" name="password" value="<%= u.getPassword() %>" required></div>
                </div>
                <div class="input-group">
                    <label>NIC / Passport</label>
                    <div class="input-container"><i class="fa-solid fa-id-card"></i>
                        <input type="text" name="nic" value="<%= u.getNic() != null ? u.getNic() : "" %>" required></div>
                </div>
                <div class="input-group">
                    <label>Phone Number</label>
                    <div class="input-container"><i class="fa-solid fa-phone"></i>
                        <input type="tel" name="phone" value="<%= u.getPhone() != null ? u.getPhone() : "" %>" required pattern="[0-9]{10}"></div>
                </div>
                <div class="input-group full-width">
                    <label>Email Address</label>
                    <div class="input-container"><i class="fa-solid fa-envelope"></i>
                        <input type="email" name="email" value="<%= u.getEmail() != null ? u.getEmail() : "" %>" required></div>
                </div>
                <div class="input-group full-width">
                    <label>Residential Address</label>
                    <div class="input-container"><i class="fa-solid fa-map-location-dot"></i>
                        <input type="text" name="address" value="<%= u.getAddress() != null ? u.getAddress() : "" %>" required></div>
                </div>
            </div>
