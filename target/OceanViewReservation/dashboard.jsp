...
<%
    ...
    Integer userId = (Integer) session.getAttribute("userId"); // ID එක ලබා ගැනීම
...
<head>
    <meta charset="UTF-8">
    <title>Ocean View Resort - Premium Dashboard</title>
    ...
    <style>
        ...
        .nav-btn {
            ...
            font-size: 14px; transition: all 0.3s ease; display: flex; align-items: center; gap: 8px;
        }
        ...
        .dashboard-wrapper {
            ...
            padding: 40px; border-radius: 20px; width: 100%; max-width: 1350px;
        ...
        .card {
            background: var(--white); padding: 30px 15px; border-radius: 16px; text-align: center; text-decoration: none;
            color: var(--text-dark); transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275);
            border: 1px solid #eef2f5; box-shadow: 0 5px 15px rgba(0,0,0,0.04); display: flex; flex-direction: column; align-items: center;
        }
        ...
        .icon-box {
            ...
            color: var(--white); border-radius: 50%; display: flex; justify-content: center; align-items: center;
            font-size: 24px; margin-bottom: 15px; transition: 0.4s; box-shadow: 0 8px 20px rgba(10,147,150,0.3);
        }
        ...
        @media (max-width: 1100px) { .grid-container { grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); } }
    </style>
</head>
<body>
...
<header>
    ...
    <div class="header-buttons">
        ...
        <a href="LogoutServlet" class="nav-btn logout-btn">
...
<main>
    <div class="dashboard-wrapper">
        <div class="welcome-header">
            ...
            <div class="user-badge"><i class="fa-solid fa-shield-halved"></i> Role: <%= userRole %></div>
        ...
        <div class="grid-container">
            <a href="booking.jsp" class="card">
                ...
                <h3>Book Room</h3>
                <p>Book a room for an existing guest.</p>
            </a>
            <a href="addReservation.jsp" class="card">
            ...
            <a href="printBill.jsp" class="card">
                <div class="icon-box"><i class="fa-solid fa-print"></i></div>
                <h3>Print Bill</h3>
