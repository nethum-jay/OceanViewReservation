...
<head>
    ...
    <style>
        :root { --primary: #005f73; --secondary: #0a9396; --accent: #94d2bd; --text-dark: #1a1a1a; --text-muted: #555; --white: #ffffff; --danger: #e63946; --warning: #ff9f1c; }
        ...
        .grid-container { display: grid; grid-template-columns: repeat(6, 1fr); gap: 15px; justify-content: center; }

        .card { background: var(--white); padding: 25px 15px; border-radius: 16px; text-align: center; text-decoration: none; color: var(--text-dark); transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); border: 1px solid #eef2f5; box-shadow: 0 5px 15px rgba(0,0,0,0.04); display: flex; flex-direction: column; align-items: center; position: relative; overflow: hidden; }
...
<main>
    <div class="dashboard-wrapper">
        ...
        <div class="grid-container">
            ...
            <a href="CancelRequestsServlet" class="card" style="border: 1px solid rgba(255, 159, 28, 0.5);">
                <div class="notification-badge"><i class="fa-solid fa-bell"></i> New</div>
                <div class="icon-box" style="background: linear-gradient(135deg, #ff9f1c, #ffbf69); box-shadow: 0 8px 20px rgba(255,159,28,0.3);">
                    <i class="fa-solid fa-ban"></i>
                </div>
                <h3 style="color: #d47e00;">Cancel Requests</h3>
                <p>Approve or deny booking cancellations.</p>
            </a>
